...
updateBasket(basket);
showItem(i1Con,itemArray[4]);
showItem(i2Con,itemArray[5]);

function showItem(container,item) 
{
    container.innerHTML += "<div class='items'><div><p style='float: left; clear: left'><img src="+item.imageSrc+" height='350px' ></p></div>"+
